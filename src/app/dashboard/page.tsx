...
export default function Dashboard() {
  return (
    <div className="chart-wrapper mx-auto flex max-w-6xl flex-col flex-wrap items-start justify-center gap-10 p-6 sm:flex-row sm:p-8">
      <div className="grid w-full gap-10 sm:grid-cols-2 lg:max-w-[22rem] lg:grid-cols-1 xl:max-w-[25rem]">
        <Card
      ...
      <div className="grid w-full flex-1 gap-10 lg:max-w-[20rem]">
        <Card
      ...
      <div className="grid w-full flex-1 gap-10">
        <Card
